...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "Data": (context) => YuliAnggrainiDataTable(),
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS-Yuli Anggraini (6SIA4)'),
        ),
        body: LoginPage(),
      ),
    );
...
class YuliAnggrainiDataTable extends StatefulWidget {
  _YuliAnggrainiDataTableState createState() => _YuliAnggrainiDataTableState();
}

class _YuliAnggrainiDataTableState extends State<YuliAnggrainiDataTable> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Yuli Anggraini- 6SIA4'),
      ),
...
class DataMahasiswa {
  ...
  static List<DataMahasiswa> getDataBarang() {
    return <DataMahasiswa>[
      DataMahasiswa(
          id: "Nama", namabarang: "Yuli Anggraini", ),
      DataMahasiswa(
          id: "Jenis Kelamin", namabarang: "Perempuan", ),
      DataMahasiswa(id: "Alamat", namabarang: "Lubuk Pakam " ),
      DataMahasiswa(
